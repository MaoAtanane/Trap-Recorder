    ...
    if (savedGames) {
      ...
      if (games.length > 0) {
        const totalScore = games.reduce(
          (sum: number, game: any) => sum + game.totalScore,
          0
        );
        const totalHits = games.reduce(
          (sum: number, game: any) => sum + game.hitCount,
          0
        );
        const averageScore = totalScore / games.length;
        const bestScore = Math.max(
          ...games.map((game: any) => game.totalScore)
        );
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          {isMobile ? (
            <MobileTabsList>
              <MobileTabsTrigger value="overview">
                <Trophy className="h-4 w-4" />
                <span>Overview</span>
              </MobileTabsTrigger>
              <MobileTabsTrigger value="scoring">
          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Ready to track your DTL performance? Start by recording your
                  first game.
                </CardDescription>
              </CardHeader>
              <CardContent>
